[![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fgudcks0305%2FTriple_BE_HOMEWORK&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false)](https://hits.seeyoufarm.com)
</a>
# Triple_BE_HOMEWORK
 트리플 BE 과제 입니다. 
...
#####  조회 기능이라  문제는 없지만 Lock이 오래 지속되면 이후 요청이 과부화가 될 수 있어 Time Out 설정을 하였습니다. 
```java
